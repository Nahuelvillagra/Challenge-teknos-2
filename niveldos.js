 var palabra = ["motor","papel","playa","llave","techo"];
...
document.getElementById("validar").addEventListener("click", function() {
    ...
    if(texto == elegida){
        ...
        document.getElementById("niv").innerHTML = '';
          ...
          document.getElementById("niv").innerHTML = "GANASTE ESTE NIVEL </br> <button><a href='niveltres.php'>Ir al siguiente</a></button>"
